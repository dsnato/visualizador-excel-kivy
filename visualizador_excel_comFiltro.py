...
class VisualizadorKivyExcelApp(App):
    def build(self):
        ...
        self.layout_principal = BoxLayout(orientation='vertical')  # Cria o layout principal vertical
        ...
        self.area_rolagem = ScrollView(size_hint=(1, 0.9), do_scroll_x=True, do_scroll_y=True, bar_width=20)  # Cria área de rolagem com barra mais grossa
    ...
    def adicionar_campos_filtro(self):
        self.input_valor = TextInput(hint_text="Digite o valor para filtrar", size_hint=(1, 0.1))  # Cria campo de texto para valor de busca
        self.layout_principal.add_widget(self.input_valor)  # Adiciona o campo de texto ao layout principal

        self.botao_filtrar = Button(text="Filtrar", size_hint=(1, 0.1))  # Cria botão para realizar filtro
